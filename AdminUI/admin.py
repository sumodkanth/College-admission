...
from .models import DepartmentDB, CourseDB, StudentDB, FacultyEnrollmentDB, JobsDB, InterviewStep, JobApplications, newsDB, newsDB2, placed_studdb, Marquee, JobStatus2,TrainingDB,CourseenrollmentDB,MultipleChoiceQuestion,Choice,TestResult, Payment,HostelRoom,BusBooking
