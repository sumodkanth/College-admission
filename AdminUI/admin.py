...
from .models import DepartmentDB, CourseDB, StudentDB, FacultyEnrollmentDB, JobsDB, placed_studdb,CourseenrollmentDB,MultipleChoiceQuestion,Choice,TestResult, Payment,HostelRoom,BusBooking
